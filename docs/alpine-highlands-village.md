...
| `lumberjack_alpine_highlands_1` | AD03.1 | Approved orchard and lumberjack station |
| `mine_alpine_highlands_1` | AD03.6 | Tall laddered mine structure with a south-running three-wide shaft |
| `well_alpine_highlands_1` | AD03.8 | Deep all-brick well, seated eight blocks below grade |
| `butchery_alpine_highlands_1` | AD02.5 | Brick-and-spruce butchery with three cows and three chickens |
