...
| `mine_mediterranean_1` | M07.8 library turned mine: it employs the miner at the station barrel under the bookshelf, digs a four-wide shaft south from the sunken room, and houses the miner in the bed with its barrel upstairs |
