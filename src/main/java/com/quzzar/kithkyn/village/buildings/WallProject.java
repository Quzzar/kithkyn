...
public final class WallProject {
  ...
  private final Set<Long> towerExclusions;
  ...
  public WallProject(List<Long> ring, Set<Long> gates, List<Integer> ground, WallTier tier,
      VillageStyle style) {
    this(ring, gates, ground, tier, style, Set.of());
  }

  public WallProject(List<Long> ring, Set<Long> gates, List<Integer> ground, WallTier tier,
      VillageStyle style, Set<Long> towerExclusions) {
    this(ring, gates, ground, style, tier,
        towerExclusions, WallTerraces.deckProfile(ground, tier.height()), List.of(), false);
  }

  /** Creates a new project with an already sampled water-aware deck profile. */
  public WallProject(List<Long> ring, Set<Long> gates, List<Integer> ground,
      List<Integer> deck, WallTier tier, VillageStyle style, Set<Long> towerExclusions) {
    this(ring, gates, ground, style, tier, towerExclusions, deck, List.of(), false);
  }

  private WallProject(List<Long> ring, Set<Long> gates, List<Integer> ground,
      VillageStyle style, WallTier tier, Set<Long> towerExclusions, List<Integer> deck,
      List<SavedSection> savedSections, boolean complete) {
    this.ring = List.copyOf(ring);
    this.gates = Set.copyOf(gates);
    this.towerExclusions = Set.copyOf(towerExclusions);
  ...
  public static WallProject completed(List<Long> ring, Set<Long> gates, List<Integer> ground,
    ...
    return new WallProject(ring, gates, ground, style, tier,
        Set.of(), WallTerraces.deckProfile(ground, tier.height()), List.of(), true);
  }

  public static WallProject completed(List<Long> ring, Set<Long> gates, List<Integer> ground,
      WallTier tier, VillageStyle style, Set<Long> towerExclusions) {
    return new WallProject(ring, gates, ground, style, tier, towerExclusions,
        WallTerraces.deckProfile(ground, tier.height()), List.of(), true);
  }

  /** A completed preview that retains its explicit water-aware deck. */
  public static WallProject completed(List<Long> ring, Set<Long> gates, List<Integer> ground,
      List<Integer> deck, WallTier tier, VillageStyle style, Set<Long> towerExclusions) {
    return new WallProject(ring, gates, ground, style, tier, towerExclusions,
        deck, List.of(), true);
  ...
  /** The wall's normalized construction cells, used to seat its derived guard posts. */
  public List<WallBlockPlan> plannedBlocks() {
    return this.sections.stream().flatMap(section -> section.blocks().stream()).toList();
  }
  ...
  public Set<Long> getTowerExclusions() {
    return this.towerExclusions;
  }
