...
import com.quzzar.kithkyn.wrongdoing.Witnesses;
  ...
  public static void onLivingSpawned(EntityJoinLevelEvent event) {
    ...
    if (com.quzzar.kithkyn.configuration.KithkynConfig.WanderingMerchant
      ...
      if (event.getEntity() instanceof net.minecraft.world.entity.npc.WanderingTrader) {
        ...
        com.quzzar.kithkyn.village.WanderingMerchantSpawner.spawnAt(merchantLevel,
            event.getEntity().blockPosition());
        return;
      }
      if (event.getEntity() instanceof net.minecraft.world.entity.animal.horse.TraderLlama llama
          && !llama.getPersistentData()
              .getBoolean(com.quzzar.kithkyn.village.WanderingMerchantSpawner.MERCHANT_LLAMA_TAG)) {
        event.setCanceled(true);
        return;
      }
    }
    ...
    if (event.getEntity() instanceof RealPerson person) {
      ...
      if (event.getSource().getEntity() instanceof net.minecraft.world.entity.LivingEntity attacker
        ...
        if (attacker instanceof Player player) {
          com.quzzar.kithkyn.relationships.OpinionService.apply(person, player.getUUID(),
              -(com.quzzar.kithkyn.configuration.KithkynConfig.AssaultOpinionHit
  ...
  public static void onLivingHurt(LivingIncomingDamageEvent event) {
    ...
    if (event.getEntity() instanceof RealPerson person) {
      ...
      if (event.getSource().getEntity() instanceof Player && person.getVillage() != null
        ...
        if (com.quzzar.kithkyn.wrongdoing.Wrongdoing.report(serverLevel, person.getVillage(),
            damagerUUID, com.quzzar.kithkyn.wrongdoing.Wrongdoing.Offence.ASSAULT,
            person.position(),
  ...
  public static void onLivingDeath(LivingDeathEvent event) {
    ...
    if (event.getEntity() instanceof RealPerson person) {
      ...
      if (event.getSource().getEntity() instanceof Player killer
        ...
        com.quzzar.kithkyn.wrongdoing.Wrongdoing.report(murderScene, person.getVillage(),
            killer.getUUID(), com.quzzar.kithkyn.wrongdoing.Wrongdoing.Offence.MURDER,
            person.position(),
