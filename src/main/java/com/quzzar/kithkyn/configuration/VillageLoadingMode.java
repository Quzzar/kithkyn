 ...
 *
 * <p>Outside developer audit isolation, every village runs its cheap
 * bookkeeping each second whatever the mode. This setting only decides whether
 * its chunks are held loaded and ticking, so it keeps building, mining,
 * farming, and defending itself unattended.
 */
